...
void URemMassInventoryItemTrait::BuildTemplate(FMassEntityTemplateBuildContext& BuildContext,
...
bool URemMassInventoryItemTrait::ValidateTemplate(const FMassEntityTemplateBuildContext& BuildContext,
    const UWorld& World,
