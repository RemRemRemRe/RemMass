...
inline const
Rem::Mass::Ability::FTreeNodeEntityArray& FRemMassAbilityTreeChildrenNodesFragment::GetValues() const
{
    return Values;
}

inline FMassEntityHandle FRemMassAbilityTreeChildrenNodesFragment::GetEntityHandle(
    const Rem::Mass::Ability::FTreeNodeNumType Index) const
{
    return Values[Index];
}
